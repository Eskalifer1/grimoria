...
description: Anti-slop frontend for landing pages, portfolios and redesigns. Reads the brief, infers a design direction, ships interfaces that don't look templated. Audit-first on redesigns, strict pre-flight check.
---
