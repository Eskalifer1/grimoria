...
export interface User {
  ...
  /**
   * Decides the User's Theme; the cookie answers for Guests only
   */
  theme?: ('standard' | 'dark-fantasy') | null;
  /**
   * Addresses the public profile. Generated on create, editable later (#5)
   */
  slug?: string | null;
  collection: 'users';
}
