...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_theme" AS ENUM('standard', 'dark-fantasy');
  CREATE TYPE "public"."enum_admin_invitations_role" AS ENUM('admin', 'user', 'moderator');
  ...
  CREATE TABLE "users" (
  	...
  	"theme" "enum_users_theme" DEFAULT 'standard',
  	"slug" varchar
  );
